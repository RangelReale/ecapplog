...
function(linuxdeployqt destdir desktopfile)
    ...
    add_custom_command(TARGET bundle POST_BUILD
                       COMMAND env QMAKE=${qmake_executable} "${LINUXDEPLOY_EXECUTABLE}" --appdir=${destdir} --plugin=qt --output=appimage -e ${CMAKE_BINARY_DIR}/ecapplog -d ${destdir}/${CMAKE_INSTALL_PREFIX}/${desktopfile}
                       WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
endfunction()
...
set(CPACK_PACKAGE_CONTACT "Rangel Reale <rangelreale@gmail.com>")
...
set(CPACK_PACKAGE_EXECUTABLES "${PROJECT_NAME}" "ECAppLog")
...
if(WIN32 AND NOT UNIX)
    ...
    set(PACKAGE_ICON "${CMAKE_SOURCE_DIR}/src/resources/ecapplog.ico")
...
elseif(APPLE)
    ...
    set(CPACK_PACKAGE_ICON ${CMAKE_SOURCE_DIR}/src/resources/ecapplog.icns)
    ...
    set(CPACK_DMG_BACKGROUND_IMAGE "${CMAKE_SOURCE_DIR}/src/resources/ecapplog.png")

    if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.13)
        set(CPACK_GENERATOR "External;${CPACK_GENERATOR}")
        message(STATUS "   + macdeployqt -dmg                     YES ")
        configure_file(${PROJECT_SOURCE_DIR}/cmake/CPackMacDeployQt.cmake.in "${CMAKE_BINARY_DIR}/CPackExternal.cmake")
